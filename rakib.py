...
'\x1b[1;91m' ༄Mr᭄•─────────────────•༄Rakib𝙧᭄
'\x1b[1;91m'   Author      ||    Mr.Rakib  
'\x1b[1;92m'   Github      ||    MR.RAKIB
...
def main_apv():
    ...
    r1=requests.get("https://github.com/MarkZuke-404/promax/blob/main/appro.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        print ("        Member In Mr.Rakib Paid Commands ")
        print ("        ENJOY  KRO BHI LOGO ")
        time.sleep(3.5)
        main_system()
    elif mx=='6':
        os.system("git clone https://github.com/mr.rakib404")
...
def numcloning():
    ...
    print ""
    os.system('echo " ༄Mr𝙧᭄•─────────────────•༄MRRAKIB𝙧᭄"| lolcat')
